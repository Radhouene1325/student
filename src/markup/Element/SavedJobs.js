		...
		<>
			...
			<div className="job-bx save-job browse-job table-job-bx clearfix">
				<div className="job-bx-title clearfix">
					<h5 className="font-weight-700 pull-left text-uppercase">269 Emplois enregistrés</h5>
					<div className="float-right">
						...
						<Link to={"#"} className="btn site-button" style={{ backgroundColor: "#0046c6"}} onClick={() => setPostModal(true)}>+ Ajouter un emploi</Link>
					</div>
				</div>
				<table>
					<thead>
					...
					<div className="">
						<form >
							<div className="modal-header">
								<h4 className="modal-title fs-20">Ajouter une tâche</h4>
								...
								<div className="add-contact-box">
									<div className="add-contact-content">
										...
										<div className="form-group">
											<label className="text-black font-w500">Titre d'emploi</label>
										...
										<div className="form-group ">
											<label className="text-black font-w500">Nom de l'entreprise</label>
											<div className="contact-name">
												<input type="text" className="form-control" autocomplete="off"
						...
						<form >
							...
							<div className="modal-body">
								...
								<div className="add-contact-box">
									<div className="add-contact-content">
										<div className="form-group ">
											<label className="text-black font-w500">Titre du poste</label>
											<div className="contact-name">
												<input type="text" className="form-control" autocomplete="off"
													name="title" required="required"
							...
							<div className="modal-footer">
								<button type="submit" className="btn btn-primary" onClick={handleEditFormSubmit}>sauvegarder</button>
