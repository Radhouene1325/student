								...
								<div className="col-xl-9 col-lg-8 m-b30">
									<div className="job-bx job-profile">
										<div className="job-bx-title clearfix">
											<h5 className="font-weight-700 pull-left text-uppercase">Changer mot de passe</h5>
											<Link to={"/jobs-cv-manager"} className="site-button right-arrow button-sm float-right" style={{ backgroundColor: "#0046c6"}}>Retour</Link>
										</div>
										<form>
											<div className="row">
												...
												<div className="col-lg-12 m-b10">
													<button className="site-button" style={{ backgroundColor: "#0046c6"}}>Modifier mot de passe</button>
												</div>
											</div>
										</form>
									</div>
